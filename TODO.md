...
> 最新实测见 [perf.md](./docs/stress-test/perf.md) 与 18 组矩阵 [stress_test_2026_08_07](./docs/stress-test/stress-test-record/stress_test_2026_08_07.md)：峰值 ~153k QPS（t6-c100），qps/MHz 归一化约为 nginx 的 67~73%
